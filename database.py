...
database_courses = (
    {
        'id': 1, 'line': 1, 'name': 'Как перевести бабушку через дорогу', 'img': 'img:старушка', 'type': 1,
    ...
    {
        'id': 2, 'line': 1, 'name': 'Как уступить место в транспорте', 'img': 'img:трамвай', 'type': 1,
    ...
    {
        'id': 3, 'line': 1, 'name': 'Как покормить голубей', 'img': 'img:голуби', 'type': 2,
    ...
    {
        'id': 4, 'line': 1, 'name': 'Как заставить себя пойти на выборы', 'img': 'img:галочка', 'type': 2,
    ...
    {
        'id': 5, 'line': 1, 'name': 'Как не лениться делать уборку', 'img': 'img:веник', 'type': 1,
    ...
    {
        'id': 6, 'line': 2, 'name': 'Как приручить соседа', 'img': 'img:лицо соседа', 'type': 1,
    ...
    {
        'id': 7, 'line': 2, 'name': 'Как заработать миллион за 15 минут', 'img': 'img:777', 'type': 2,
